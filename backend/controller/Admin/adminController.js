const Admin = require('../../models/admin'); // Perhatikan path yang benar
const Product = require('../../models/product');
const User = require('../../models/User');
// const Notification = require('../../models/notification'); // Komentar untuk sekarang
...
exports.deleteProduct = async (req, res) => {
  try {
    ...
    // Komentar notifikasi untuk sementara
    /*
